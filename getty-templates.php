	...
	<div class="getty-user-panel {{ loginClass }}">
		...
		<div class="getty-images-login">
			<p class="getty-login-username">
				...
				<a href="https://secure.gettyimages.com/forgot-username" class="forgot" target="_getty"><?php _e( "Forgot username?", 'getty-images' ); ?></a>
			</p>
			<p class="getty-login-password">
				...
				<a href="https://secure.gettyimages.com/Account/ForgotPassword.aspx" class="forgot" target="_getty"><?php _e( "Forgot password?", 'getty-images' ); ?></a>
			</p>
		...
		<div class="logged-in-status">
			<p>
				<strong class="getty-images-username"><?php _e( "Logged in as: ", 'getty-images' ); ?> {{ data.username }}</strong>
			</p>
			<# if(data.products && data.products.length) { #>
			<p>
				<strong class="getty-images-product-offerings"><?php _e( "Products: ", 'getty-images' ); ?></strong>
			...
			<# } #>
			<p>
				<a href="#" class="getty-images-logout"><?php _e( "log out", 'getty-images' ); ?></a>
			</p>
		</div>
		<# } #>
	</div>
...
<# }
	...
	<p class="description"><?php _e( "Downloading authorizations...", 'getty-images' ); ?></p>
<# } #>
</script>

<script type="text/html" id="tmpl-getty-image-details-list">
<dl class="getty-image-details-list">
	<dt class="getty-title"><?php _e( "Title: ", 'getty-images' ); ?></dt>
	<dd class="getty-title">{{ data.Title }}</dd>

	<dt class="getty-image-id"><?php _e( "Image #: ", 'getty-images' ); ?></dt>
	<dd class="getty-image-id">{{ data.ImageId }}</dd>

	<dt class="getty-artist"><?php _e( "Artist: ", 'getty-images' ); ?></dt>
	<dd class="getty-artist">{{ data.Artist }}</dd>

	<dt class="getty-collection"><?php _e( "Collection: ", 'getty-images' ); ?></dt>
	...
	<dt class="getty-release-info"><?php _e( "Release Information: ", 'getty-images' ); ?></dt>
...
<# if(data.ImageId) {
	...
	<div class="thumbnail">
		...
		<# } else { #>
		<h3><?php _e( "(Thumbnail Unavailable)", 'getty-images' ); ?></h3>
		<# } #>
	</div>

	<# if(attachment) { #>
		<div class="filename"><?php _e( "Filename", 'getty-images' ); ?>: {{ attachment.filename }}</div>
		<div class="uploaded"><?php _e( "Downloaded", 'getty-images' ); ?>: {{ attachment.dateFormatted }}</div>
...
<script type="text/html" id="tmpl-getty-images-more">
	<div class="attachment-preview">
		...
		<div class="getty-more-text-container">
			...
			<span class="getty-more-text"><?php _e( "More", 'getty-images' ); ?></span>
		</div>
	</div>
</script>
